  ...
  const services = [
    {
      ...
      description:
        "We assign and validate 9-1-1 addresses for properties in unincorporated areas of Hidalgo and Willacy Counties.",
      icon: <FaMapMarked />,
    ...
    },
    {
      ...
      description:
        "We review and assign addresses for new subdivisions submitted by developers or cities.",
      icon: <FaBuilding />,
    ...
    },
    {
      ...
      description:
        "We add and verify streets, maintain parity, and ensure proper road naming in coordination with city staff.",
      icon: <FaRoad />,
  ...
  const tabs = [
    {
      ...
      content: (
        <div className={styles.tabContent}>
          ...
          <p>
            We process all incoming address requests through a defined 3-step
            workflow:
          </p>
          <ol className={styles.workflowList}>
            <li>Assigning and validating the property address</li>
            <li>
              Inserting the address into our 9-1-1 GIS Enterprise Geodatabase
              Management System
            </li>
            <li>
              Running QA/QC checks before pushing the data to our Location
              Validation Function (LVF)
            </li>
          </ol>

          <p>
            The LVF is critical to 9-1-1 call delivery. It provides the
            telephone companies with the information needed to correctly route
            9-1-1 calls.
          </p>
    ...
    },
    {
      ...
      content: (
        <div className={styles.tabContent}>
          ...
          <p>
            In 2021, The Rio Grande Valley Emergency Communication District
            (RGV9-1-1) completed the transition from a tabular 9-1-1 database
            (MSAG) to the GIS-driven GeoMSAG. Our team uses the following
            technologies:
          </p>

          <ul className={styles.technologyList}>
            <li>
              <strong>ESRI ArcGIS Pro 2.8.1</strong> - For advanced geospatial
              analysis and mapping
            </li>
            <li>
              <strong>ESRI Address Data Management Toolset</strong> - For
              maintaining address data integrity
            </li>
            <li>
              <strong>ArcGIS Enterprise 11.5</strong> - For enterprise-level GIS
              capabilities
            </li>
            <li>
              <strong>ArcGIS Portal</strong> - For web-based mapping and
              collaboration
            </li>
            <li>
              <strong>Location Validation Function (LVF)</strong> - For
              validating and routing 9-1-1 calls
            </li>
          </ul>

          <p>
            Our GIS data is replicated into the 9-1-1 mapping system used at
            each of our 17 Public Safety Answering Points (PSAPs), allowing
            telecommunicators to quickly locate callers and direct emergency
            service personnel.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className={styles.tabContent}>
          ...
          <p>
            The GIS Department works closely with various stakeholders to ensure
            accurate and up-to-date geospatial information for emergency
            services:
          </p>

          <ul className={styles.partnersList}>
            <li>
              <strong>Municipal Governments</strong> - Coordinating address
              assignments and street naming within city limits
            </li>
            <li>
              <strong>County Governments</strong> - Managing addressing in
              unincorporated areas
            </li>
            <li>
              <strong>Developers</strong> - Processing new subdivisions and
              developments
            </li>
            <li>
              <strong>Utility Companies</strong> - Sharing infrastructure data
              for emergency response
            </li>
            <li>
              <strong>Emergency Service Providers</strong> - Ensuring accurate
              location data for response
            </li>
          </ul>

          <p>
            These partnerships are essential for maintaining a comprehensive and
            accurate geospatial database that supports emergency communications
      ...
      <main className={styles.main}>
        <div className={styles.container}>
          ...
          <section className={styles.directorSection}>
            <SectionTitle title="Department Leadership" icon={<FaUsers />} />
          ...
          <ContactSection
            ...
            ctaButtonText="Learn More About Our GIS Department"
            ctaLink="/departments/gis/services"
          />
        </div>
      </main>
